...
<p>Ce projet peut être bien développer en une application mobile .Et par conséquence ,on peut lire automatiquement la fonction f(x) à partir de la caméra de téléphone sans besion de l'ecrire à l'aide </p>
