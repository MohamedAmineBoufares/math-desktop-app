...
<p>Ce projet peut être bien développer en une application mobile .Et par conséquence , on peut lire automatique la fonction f(x) à partir de la caméra de téléphone sans besion de l'ecrire.</p>
